$(document).ready(() => {
  ...
  function findCoordinates() {
    ...
    let startCord =
      ...
      getstart +
      ".json?access_token=pk.eyJ1Ijoicm9zczFqayIsImEiOiJja2p0YzJ0bmowOTd3MnFxc2c0Z2NiMWw0In0.3mcyR7CpPBKi_sGyVdA26A";
    let endCord =
      "https://api.mapbox.com/geocoding/v5/mapbox.places/" +
      getend +
      ".json?access_token=pk.eyJ1Ijoicm9zczFqayIsImEiOiJja2p0YzJ0bmowOTd3MnFxc2c0Z2NiMWw0In0.3mcyR7CpPBKi_sGyVdA26A";
  ...
  routeURL =
    ...
    ";" +
    endCordLS +
    "?steps=true&access_token=pk.eyJ1Ijoicm9zczFqayIsImEiOiJja2p0YzJ0bmowOTd3MnFxc2c0Z2NiMWw0In0.3mcyR7CpPBKi_sGyVdA26A";
  $.ajax({
    url: routeURL,
    method: "GET",
  }).then(function(response) {
  ...
  let mapurl =
    ...
    localStorage.getItem("startCord") +
    "),pin-s-b+000(" +
    localStorage.getItem("endCord") +
    ")/auto/500x300?access_token=pk.eyJ1Ijoicm9zczFqayIsImEiOiJja2p0YzJ0bmowOTd3MnFxc2c0Z2NiMWw0In0.3mcyR7CpPBKi_sGyVdA26A";
  console.log(mapurl);
